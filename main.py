...
# file_relative_path = "test1.pdf"
file_relative_path = "merged.pdf"
...
async def main():
    ...
    st.title("You can ask anything about budget")
    ...
    # Add your code here that needs to be executed
        with open(file_path, "rb") as file:
            ...
            vectors = await getDocEmbeds(io.BytesIO(file), os.path.basename(file_path))
    ...
    if st.session_state['ready']:
        ...
        if 'generated' not in st.session_state:
            st.session_state['generated'] = ["You can ask anything about budget"]
        ...
        with container:
            with st.form(key='my_form', clear_on_submit=True):
                user_input = st.text_input("Query:", placeholder="e.g: List all social economic statements", key='input')
